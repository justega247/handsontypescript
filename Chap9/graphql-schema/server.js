...
(function () {
    return __awaiter(this, void 0, void 0, function () {
        var app, httpServer, pubsub, schema, apolloServer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    subscriptions_transport_ws_1.SubscriptionServer.create({ schema: schema, execute: graphql_1.execute, subscribe: graphql_1.subscribe }, { server: httpServer, path: apolloServer.graphqlPath });
